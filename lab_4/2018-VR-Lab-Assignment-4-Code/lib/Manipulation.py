...
class IsotonicRateControlManipulation(Manipulation):
    ...
    def manipulate(self):
        ...
        _z = self.mf_dof.value[2]
        print(_x, _y, _z)
        self.vmx[0] = _x / _delta_t 
        self.vmx[1] = _y / _delta_t
        self.vmx[2] = _z / _delta_t
        ...
        _vz = self.vmx[2] * k
        # accumulate input
        _new_mat = avango.gua.make_trans_mat(_vx*_delta_t, _vy*_delta_t, _vz*_delta_t) * self.sf_mat.value
...
class IsotonicAccelerationControlManipulation(Manipulation):
    ...
    def manipulate(self):
        ...
        m_acc = [m_acc[i] for i in range(3)]
...
class ElasticAccelerationControlManipulation(Manipulation):
    ...
    def manipulate(self): 
        ...
        k = 5.0
        h_acc = [[_x, _y, _z][i]*k for i in range(3)]
        h_dist = [0.5*h_acc[i]*_delta_t**2 for i in range(3)]
