...
def init_art_tracking_wall():
    ...
    _dtrack.stations[5] = avango.daemon.Station('tracking-glasses-1') # ASUS 3D mirror display
    _dtrack.stations[10] = avango.daemon.Station('tracking-glasses-2') # 3D-TV (Mitsubishi) wired shutter glasses
    _dtrack.stations[2] = avango.daemon.Station('tracking-glasses-3') # small powerwall polarization glasses
...
def init_art_tracking_3DTV():
    ...
    _dtrack.stations[1] = avango.daemon.Station('tracking-glasses-4') # Samsung 3D-TV wired shutter glasses
...
def init_pointer4(): # 2.4G Mouse Samsung 3DTV
